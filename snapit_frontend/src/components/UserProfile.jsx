...
const activeBtnStyles = 'text-black font-bold p-2 w-20 outline-none border-b-2 border-red-500 mr-5 ml-5 mt-2';
const notActiveBtnStyles = 'text-black font-bold p-2 w-20 outline-none mr-5 ml-5 mt-2';
            ...
            <div className='flex flex-col pb-5'>
                <div className='relative flex flex-col mb-7'>
                    <div className='flex flex-col justify-center items-center'>
                        ...
                        <img src={user.image} alt="user" className='rounded-full w-30 h-30 -mt-10 shadow-xl object-cover'/>
                        ...
                        <div className='absolute top-0 z-1 right-0 p-2'>
                            {userId === user._id && (
                                ...
                                </button>)} onLogoutSuccess={logout} cookiePolicy='single_host_origin' />
                            )}
                        </div>
                    </div>
