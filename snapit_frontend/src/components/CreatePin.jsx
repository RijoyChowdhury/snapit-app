...
const CreatePin = ({ user }) => {
    ...
    const uploadImage = (e) => {
        ...
        if (type.match(/^image\/(png|svg|jpeg|jpg|gif|tiff)$/)) {
        ...
        <div className='flex flex-col justify-center items-center mt-5 lg:h-4/5'>
            ...
            <div className='flex xl:flex-row flex-col justify-center items-center bg-white lg:p-5 p-3 lg:w-4/5 w-full'>
                        ...
                        {!imageAsset ? (
                            !loading && (<label>
                                <div className='flex flex-col items-center justify-center h-full'>
                                    ...
                                    <p className='mt-5 text-gray-400'>Use high-quality JPG, SVG, PNG or GIF less than 20 MB</p>
                                </div>
                                <input type='file' name='upload-image' onChange={uploadImage} className='w-0 h-0' />
                            </label>)
                        ) : (
                            <div className='relative h-full'>
                                <img src={imageAsset?.url} alt="uploaded-image" className='h-full w-full object-contain' />
                ...
                <div className='flex flex-1 flex-col gap-6 lg:pl-5 mt-5 w-full'>
                    <input type='text' value={title} onChange={(e) => setTitle(e.target.value)} placeholder='Add title here' className='outline-none text-2xl sm:text-3xl font-bold border-b-2 border-gray-200 p-2' />
                    {user && (
                    ...
                    <input type='text' value={about} onChange={(e) => setAbout(e.target.value)} placeholder='About...' className='outline-none text-base sm:text-lg border-b-2 border-gray-200 p-2' />
                    ...
                    <div className='flex flex-column'>
                        <div className='flex flex-row gap-6'>
                            <p className='mb-2 font-semibold text-lg sm:text-xl w-full'>Choose Category</p>
